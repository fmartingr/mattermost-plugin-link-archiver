...
```
git clone --depth 1 https://github.com/mattermost/mattermost-plugin-starter-template com.example.auto-archiver
```
...
```
dist/com.example.auto-archiver.tar.gz
```
