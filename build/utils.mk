...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination=server/command/mocks/mock_commands.go -package=mocks git.nakama.town/fmartingr/mattermost-plugin-auto-archiver/server/command Command
endif
